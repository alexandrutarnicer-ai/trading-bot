...
export const MARKET_SPECS: Record<string, MarketSpec> = {
  ...
  // Crosses EUR/GBP
  EURCAD: { volMin: 0.01, pipVal: 7.5,  typSl: 30,    minCapital: 150 },
  GBPCAD: { volMin: 0.01, pipVal: 9.5,  typSl: 35,    minCapital: 200 },
  EURAUD: { volMin: 0.01, pipVal: 7.5,  typSl: 35,    minCapital: 150 },
  GBPAUD: { volMin: 0.01, pipVal: 9.5,  typSl: 40,    minCapital: 200 },
  AUDCAD: { volMin: 0.01, pipVal: 7.0,  typSl: 25,    minCapital: 100 },
  AUDNZD: { volMin: 0.01, pipVal: 7.0,  typSl: 25,    minCapital: 100 },
  // Indici — pip = 1 punct, vol_min = 0.1 loturi (ICMarketsEU)
  GER40:  { volMin: 0.1,  pipVal: 1.14, typSl: 200,   minCapital: 250 },
  DE40:   { volMin: 0.1,  pipVal: 1.14, typSl: 200,   minCapital: 250 },
