"""
UK100 Quick Test — FTSE 100 M15
================================
UK100: 8.7 ani, spread real ~$5 (500 ticks), deja configurat in engine.
"""
...
def main():
    print("=" * 72)
    print("  UK100 Quick Test — FTSE 100 (8.7 ani date)")
    ...
    if best:
        ...
        print(f"\n  >> UK100 CEL MAI BUN: {best['sess']} PW={best['pw']} {best['dir']} "
              f"| test={best['e_te']:+.3f}R p={p_s} {best['freq']:.1f}/s DD={best['dd']:+.0f}% {ann}")

    print("\n" + "=" * 72)
    if not candidates:
        print("  UK100: Niciun config cu edge confirmat.")
    else:
        print("  UK100 EDGE CONFIG:")
